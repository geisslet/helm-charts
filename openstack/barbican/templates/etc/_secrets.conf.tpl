...
# Default values
hmac_key_length = 32
mkek_label = {{ .Values.lunaclient.multi.mkek_label | include "resolve_secret" }}
mkek_length = {{ .Values.lunaclient.multi.mkek_length }}
hmac_label = {{ .Values.lunaclient.multi.hmac_label | include "resolve_secret" }}
